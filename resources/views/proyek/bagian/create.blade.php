...
<div class="card mx-5 my-4">
    <div class="card-header py-3">
        <h1>Tambah Bagian Perusahaan</h1>
        <form action="{{ route('bagian.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="nama_bagian" class="form-control" name="nama_bagian" required>
            </div>
            <div class="form-group">
                <label for="kode_bagian">Initial Bagian:</label>
                <input type="text" id="kode_bagian" class="form-control" name="kode_bagian" required>
            </div>
            <div class="form-group">
                <label for="tagihan_harian">Tagihan Harian Perbagian:</label>
                <input type="text" id="tagihan_harian" class="form-control" name="tagihan_harian" required>
            </div>
            <div class="form-group">
                <label for="tagihan_harian_perjam">Tagihan Harian Lemburan PerJam:</label>
                <input type="text" id="tagihan_harian_perjam" class="form-control" name="tagihan_harian_perjam" required>
            </div>
