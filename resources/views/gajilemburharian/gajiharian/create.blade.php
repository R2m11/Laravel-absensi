...
<div class="card mx-5 my-4">
    <div class="card-header py-3">
        ...
        <form action="{{ route('gajiharian.store') }}" method="POST">
            @csrf
            <div class="form-group">
                <label for="desc_gaji">Deskripsi Gaji :</label>
                <input type="text" id="desc_gaji" class="form-control" name="desc_gaji" required>
            </div>
            <div class="form-group">
                <label for="gaji">Nominal Gaji Harian:</label>
                <input type="text" id="gaji" class="form-control" name="gaji" required>
            </div>
            <div class="form-group">
                <label for="lembur_perjam">Nominal Lembur Perjam:</label>
                <input type="text" id="lembur_perjam" class="form-control" name="lembur_perjam" required>
            </div>
