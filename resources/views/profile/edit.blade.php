    ...
    <form action="/profile/{{$profile->id}}" method="post" enctype="multipart/form-data">
        ...
        <div class="card mx-3 my-4 py-2">
            ...
            <div class="form-group mx-4">
                ...
                <input type="text" name="kode_karyawan" class="form-control" value="{{ old('npm', $profile->kode_karyawan) }}" disabled>
            </div>

            <div class="form-group mx-4">
                <label for="gender" class="text-md text-primary font-weight-bold">Jenis Kelamin</label>
                <input type="text" name="gender"class="form-control" value="{{ old('prodi', $profile->gender) }}" disabled>
            </div>
